...
public partial class Story : IStory, IEntity<StoryModel>
{
    ...
    public static IList<Story> Search(Int32 versionId, Int32 memberId, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
