...
public partial class VersionPlan : IVersionPlan, IEntity<VersionPlanModel>
{
    ...
    public static IList<VersionPlan> Search(Int32 teamId, Int32 productId, Boolean? completed, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
