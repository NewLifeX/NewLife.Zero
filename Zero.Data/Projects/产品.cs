...
public partial class Product : IProduct, IEntity<ProductModel>
{
    #region 属性
    private Int32 _ID;
    /// <summary>编号</summary>
    ...
    public void Copy(ProductModel model)
    {
        ID = model.ID;
        TeamId = model.TeamId;
        Name = model.Name;
    ...
    public static IList<Product> Search(Boolean? completed, Boolean? enable, DateTime start, DateTime end, String key, PageParameter page)
    {
